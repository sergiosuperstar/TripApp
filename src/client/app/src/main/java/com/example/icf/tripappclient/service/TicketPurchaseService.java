...
public interface TicketPurchaseService {
   ...
   @Headers({
    ...
    @POST("tickets/")
    Call<TicketPurchase> add(@Header("Authorization") String auth, @Header("DeviceID") String notificationToken,@Header("Notifications") Boolean notificationEnabled, @Body TicketPurchase ticketPurchase);
